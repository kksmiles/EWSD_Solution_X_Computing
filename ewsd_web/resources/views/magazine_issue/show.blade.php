            ...
            <div class="card-body bg-light col-11 ml-md-4 issue-content">
                <div class="row px-md-2">
                    ...
                    <div class="mt-md-3 card p-3 col-md-7 col-12 mx-md-3">
                        ...
                        <ul class="list-group border-0 smla">
                            <li class="list-group-item">
                                Submission Closure Date : <span class="text-warning font-weight-bold text-monospace"> {{ $magazine_issue->submission_closure_date }} </span>
                            </li>
                            <li class="list-group-item">
                                Modification Closure Date : <span class="text-danger
                                 font-weight-bold text-monospace"> {{ $magazine_issue->modification_closure_date }}</span>
                            </li>
                            <li class="list-group-item">
                    ...
                    <div class="col-md-4 card mt-md-3">
                        <a href="{{ $magazine_issue->file }}" class='btn btn-primary mt-2' download="">
                            <i class="fas fa-download"></i> Download associated file</a>
                        @if(Gate::allows('isStudent'))
                            <a class="btn btn-primary mt-2" href="{{ route('student.magazine-issues.contributions', $magazine_issue->id) }}">Your Contributions </a>
